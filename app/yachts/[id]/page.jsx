          ...
          <div className="container m-auto py-10 px-6">
            <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
              ...
              <aside className="space-y-4">       
                ...
                >
                  <i className="fas fa-bookmark mr-2"></i> Bookmark Yacht
                </button>
                <button
                ...
                >
                  <i className="fas fa-share mr-2"></i> Share Yacht
                </button>

                {/* <!-- Contact Form --> */}
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h3 className="text-xl font-bold mb-6">Contact Yacht Owner</h3>
                  <form>
                  <div className='mb-4'>
                    <label
